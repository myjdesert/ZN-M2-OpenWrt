...
if [ -f "$TARGET_MAKEFILE" ]; then
    # Remove kmod-ath11k-ahb and wpad-openssl from DEFAULT_PACKAGES
...
grep -A8 "define Device/zn_m2" "$IPQ60XX_MK" 2>/dev/null || echo "  -> WARNING: zn_m2 not found in ipq60xx.mk!"
echo ""
